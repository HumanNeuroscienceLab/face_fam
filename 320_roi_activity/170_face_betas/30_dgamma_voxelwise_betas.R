...
# 3519
n(std.rdats.all$r.vATL)
sum(sapply(std.rdats.all, ncol))
...
save(grp.bs1, sub.bs1, bvnames, file="/data1/famface01/analysis/misc/320_roi_task_activity/dgamma_voxelwise_betas.rda")
