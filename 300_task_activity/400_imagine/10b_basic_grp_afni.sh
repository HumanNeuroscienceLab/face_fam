...
outdir="/data1/famface01/analysis/task_activity/group/imagine/imagine_main+identity.mema"
taskdir_template="/data1/famface01/analysis/task_activity/__SUBJECT__/imagine/imagine_main+identity.reml"
