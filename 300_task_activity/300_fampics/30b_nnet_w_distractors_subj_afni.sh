...
outdir="/data1/famface01/analysis/task_activity/group/fampics/fampics_nnet_deviate_w_distractor.mema"
taskdir_template="/data1/famface01/analysis/task_activity/__SUBJECT__/fampics/fampics_nnet_deviate_w_distractor.reml"
...
echo "=> ${contrasts[@]}"
#contrasts=( avg_diff_person avg_diff_all )
