...
outdir="/data1/famface01/analysis/task_activity/group/fampics/fampics_nnet_deviation.mema"
taskdir_template="/data1/famface01/analysis/task_activity/__SUBJECT__/fampics/fampics_nnet_deviation.reml"
