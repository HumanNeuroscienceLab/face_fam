...
outdir="${outbase}/nnet_masked_mean_diff.reml"
...
${tog}/task_analysis.rb -i ${fundir}/unfam_vids/filtered_func_run??.nii.gz \
  ...
  --stim-am1 mean_diff ${tdir}/stimam_nnet_masked_mean_diff.txt 'SPMG1(2)' \
  --stim-am1 mean_framediff ${tdir}/stimam_nnet_masked_mean_frame_diff.txt 'SPMG1(2)' \
