...
outdir="${outbase}/nnet2_avg1_effects.reml"
...
${tog}/task_analysis.rb -i ${fundir}/unfam_vids/filtered_func_run??.nii.gz \
  ...
  --stim-am1 frame_diff ${tdir}/stimam_nnet2_frame_mean_diff.txt 'SPMG1(2)' \
  --stim-am1 pose ${tdir}/stimam_nnet2_pose.txt 'SPMG1(2)' \
  --stim-am1 frame_pose ${tdir}/stimam_nnet2_frame_pose.txt 'SPMG1(2)' \
