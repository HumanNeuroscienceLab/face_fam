...
outdir="/data1/famface01/analysis/task_activity/group/face_deviations_unfam/main_face_measures.mema"
taskdir_template="/data1/famface01/analysis/task_activity/__SUBJECT__/face_deviations_unfam/main_face_measures.reml"
