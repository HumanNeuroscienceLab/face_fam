...
# parallel --no-notice -j $njobs --eta bash 408a_4dface_pca3_subj_afni.sh {} ::: ${subjects[@]}
...
outdir="${outbase}/4dface_pca_shape_update_me.reml"
...
${tog}/task_analysis.rb -i ${fundir}/unfam_vids/filtered_func_run??.nii.gz \
  ...
  --stim-am1 pose ${tdir}/stimam_4dface3_pca_pose.txt 'SPMG1(2)' \
  --stim-am1 shape ${tdir}/stimam_4dface3_pca_shape.txt 'SPMG1(2)' \
  --stim-am1 texture ${tdir}/stimam_4dface3_pca_texture.txt 'SPMG1(2)' \
  --stim-am1 expression ${tdir}/stimam_4dface3_pca_expression.txt 'SPMG1(2)' \
  --stim-am1 fw_pose ${tdir}/stimam_4dface3_pca_framewise_pose.txt 'SPMG1(2)' \
  --stim-am1 fw_shape ${tdir}/stimam_4dface3_pca_framewise_shape.txt 'SPMG1(2)' \
  --stim-am1 fw_expression ${tdir}/stimam_4dface3_pca_framewise_expression.txt 'SPMG1(2)' \
  --regdir ${fundir}/reg \
  --tostandard \
  --threads ${nthreads}
