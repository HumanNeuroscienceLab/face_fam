...
outdir="/data1/famface01/analysis/task_activity/group/face_basics_unfam/raw_demo_trait_feats_sm4_whole.mema"
...
#run "3dcalc -a $FSLDIR/data/standard/tissuepriors/2mm/gray_20perc.nii.gz -expr 'a' -prefix mask_grey.nii.gz"
