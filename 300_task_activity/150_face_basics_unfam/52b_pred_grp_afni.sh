...
outdir="/data1/famface01/analysis/task_activity/group/face_basics_unfam/pred_demo_trait_feats.mema"
taskdir_template="/data1/famface01/analysis/task_activity/__SUBJECT__/face_basics_unfam/pred_demo_trait_feats.reml"
