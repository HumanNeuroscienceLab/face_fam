...
outdir="${outbase}/resid_demo_trait_feats.reml"
...
${tog}/task_analysis.rb -i ${fundir}/unfam_vids/filtered_func_run??.nii.gz \
  ...
  --stim-am1 resid_demo_age ${tdir}/stimam_age_resid.txt 'SPMG1(2)' \
  --stim-am1 resid_demo_gender ${tdir}/stimam_gender_resid.txt 'SPMG1(2)' \
  --stim-am1 resid_demo_glasses ${tdir}/stimam_glasses_resid.txt 'SPMG1(2)' \
  --stim-am1 resid_demo_makeup ${tdir}/stimam_makeup_resid.txt 'SPMG1(2)' \
  --stim-am1 resid_t01_unemotional ${tdir}/stimam_trait01_resid.txt 'SPMG1(2)' \
  --stim-am1 resid_t02_competent ${tdir}/stimam_trait02_resid.txt 'SPMG1(2)' \
  --stim-am1 resid_t03_trustworthy ${tdir}/stimam_trait03_resid.txt 'SPMG1(2)' \
  --stim-am1 resid_t04_memorable ${tdir}/stimam_trait04_resid.txt 'SPMG1(2)' \
  --stim-am1 resid_t05_attractive ${tdir}/stimam_trait05_resid.txt 'SPMG1(2)' \
