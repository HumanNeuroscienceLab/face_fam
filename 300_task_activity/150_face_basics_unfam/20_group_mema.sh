...
outdir="/data1/famface01/analysis/task_activity/group/face_basics_unfam/demos.reml"
taskdir_template="/data1/famface01/analysis/task_activity/__SUBJECT__/face_basics_unfam/demos.reml"
